...
export default function TeacherSettingsView() {
  ...
  const fetchSettings = useCallback(async () => {
    ...
    try {
      setLoading(true);
      const res = await fetch(`/api/teacher/settings?userId=${user.id}`);
      ...
      setSpecialization(data.teacher.specialization || '');
    } catch (err) {
        ...
        setSettingsData((prev) =>
          prev
            ? {
                ...
                teacher: { ...prev.teacher, ...data.teacher },
              }
            : prev
        );
      } else {
  ...
  const teacherLevel = settingsData?.teacher.level;
  const teacherSubject = settingsData?.teacher.subject;
            ...
            <CardContent className="space-y-5">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Badge
                    variant="outline"
                    className="w-full justify-center py-2.5 text-sm border-edutrack-primary/20 text-edutrack-primary bg-edutrack-primary/5"
                  >
                    <BookOpen className="h-3.5 w-3.5 ml-1.5" />
                    {getLevelLabel(teacherLevel)}
                  </Badge>
                </div>
                <div className="space-y-2">
                  <Label className="text-sm font-medium text-muted-foreground">
                  ...
                  <Badge
                    variant="outline"
                    className="w-full justify-center py-2.5 text-sm border-edutrack-secondary/20 text-edutrack-secondary bg-edutrack-secondary/5"
                  >
                    <BookOpen className="h-3.5 w-3.5 ml-1.5" />
                    {teacherSubject?.name || 'غير محدد'}
                  </Badge>
                </div>
              </div>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between p-3.5 bg-gray-50 rounded-xl">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-xs text-muted-foreground">المادة المسندة</p>
                    <p className="text-sm font-semibold text-edutrack-dark">
                      {teacherSubject?.name || 'غير محدد'}
                    </p>
                  </div>
              ...
              <div className="flex items-center justify-between p-3.5 bg-gray-50 rounded-xl">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-xs text-muted-foreground">المستوى المسند</p>
                    <p className="text-sm font-semibold text-edutrack-dark">
                      {getLevelLabel(teacherLevel)}
                    </p>
                  </div>
              ...
              {/* Specialization */}
              {(settingsData?.teacher.specialization || specialization) && (
                <div className="flex items-center justify-between p-3.5 bg-gray-50 rounded-xl">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-semibold text-edutrack-dark">
                        {settingsData?.teacher.specialization || specialization || 'غير محدد'}
                      </p>
                    </div>
                  </div>
                </div>
